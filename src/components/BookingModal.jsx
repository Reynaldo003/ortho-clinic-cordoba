...
import { CalendarClock, PlayCircle, ShieldCheck, MessageCircle, Clock, BadgeCheck, MapPin, X } from "lucide-react";
            ...
            >
              <DialogPanel className="w-full overflow-hidden rounded-2xl bg-[#0B1220] text-slate-100 ring-1 ring-white/10 shadow-2xl">
                ...
                <div className="grid grid-cols-1 gap-6 p-5 md:grid-cols-12">
                  {/* Col izquierda: media + info rápida */}
                  <div className="md:col-span-5 xl:col-span-4">
                    ...
                    {/* Fichas compactas para llenar espacio */}
                  ...
                  {/* Col derecha: agenda + resumen (ocupa el resto) */}
                  <div className="md:col-span-7 xl:col-span-8">
                    ...
                    {/* Panel de resumen / políticas (compacto y sin huecos) */}
                    <div className="mt-4 grid gap-4 md:grid-cols-5">
                      ...
                      <div className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10 md:col-span-2">
                        ...
                        <p className="mt-1 text-xs leading-5 text-slate-400">
                          ...
                          Las citas pueden reprogramarse hasta 12 h antes.  
                          En caso de urgencia, contáctanos por WhatsApp.
                        </p>
                        <a
