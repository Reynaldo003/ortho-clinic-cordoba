...
export default function ProfileCard({ person }) {
  ...
  return (
    <>
      <article
        className="group relative overflow-hidden rounded-2xl border border-white/10 bg-slate-900/60 ring-1 ring-white/10 shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:shadow-xl hover:ring-white/20"
      >
        {/* Decoración */}
        <div
          aria-hidden
